...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        html_template = 'user/email_confirmation_signup_message.html'
        ...
        subject = render_to_string('user/email_confirmation_subject.txt')
...
class PasswordResetSerializer(serializers.Serializer):
    ...
    def get_email_options(self):
        ...
        return {
            'subject_template_name': 'user/reset-password-subject.txt',
            'html_email_template_name': 'user/reset-password-email.html',
    ...
    def validate_email(self, value):
        ...
        self.user = UserAccount.objects.get(email=value)
